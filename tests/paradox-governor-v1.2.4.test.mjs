...
console.log('OK: v1.2.4 conversation recall and standalone-name capture passed.');
...
console.log('OK: v1.2.4 concise multi-rule and compound-answer tests passed.');
...
console.log('OK: v1.2.4 deterministic company grounding tests passed.');
...
assert.match(solarDetail.reply, /consumo eléctrico/i);
assert.match(solarDetail.reply, /no emite cotizaciones/i);
assert.doesNotMatch(solarDetail.reply, /mantenimiento|reparación|monitoreo/i);
assert.ok(solarDetail.contextSelection.metrics.requiredRules.includes('COMPANY-SOLAR-GROUNDING'));
...
console.log('OK: v1.2.4 commercial grounding and quote-integrity tests passed.');
...
console.log('OK: v1.2.4 deterministic quote path and Groq retry passed.');
...
console.log('OK: v1.2.4 stack inference, encoded-instruction and compound-memory tests passed.');
